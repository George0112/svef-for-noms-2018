...
plt.text(100,5.5,'Average layers:'+ str(round(float(count_receive)/240, 2)),fontsize=16)
plt.text(100,5.1,'Received Pkts:'+ str(count_receive),fontsize=16)
plt.text(100,4.7,'Missed Pkts:'+ str(count_miss),fontsize=16)
plt.text(100,4.3,'Missed Frames:' + str(miss_frame),fontsize=16)
plt.text(100,3.9,'Undecodable Pkts:'+str(undecode_pkt),fontsize=16)
